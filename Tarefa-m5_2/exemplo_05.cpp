...
// Para compilar -> Estar no diretorio do arquivo exemplo_05.cpp
// g++ exemplo_05.cpp -o ex05 ../src/glad.c gl_utils.cpp stb_image.cpp -I include -I../include -L/usr/lib/x86_64-linux-gnu/ -L/usr/lib64 -lGLEW -lGL -lX11 -lglfw -lrt -lm -ldl
